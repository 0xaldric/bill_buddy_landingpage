        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="text-center lg:text-left">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Split bills instantly in your <span className="text-blue-600">Telegram group.</span>
            </h1>
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl shadow-2xl p-6 max-w-md mx-auto">
              <div className="flex items-center gap-3 mb-4 pb-4 border-b">
                <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white font-bold">BB</div>
                <div>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-blue-50 rounded-lg p-4 border-l-4 border-blue-600">
                  ...
                  <p className="text-sm text-gray-700 mb-2">💰 Bill split: $450</p>
